            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="powered">
                        <p>Car Shop &copy; All Rights Reserved. With Made With Love By
                            <a href="https://themeforest.net/user/7oroof/portfolio?ref=7oroof">7oroof.com</a>
                        </p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="payment-methods text-right">
                        <ul class="list-inline mb-0">
                            <li><img src="src/assets/images/footer/visa.png" alt="payment"></li>
                            <li><img src="src/assets/images/footer/mastercard.png" alt="payment"></li>
                            <li><img src="src/assets/images/footer/american-express.png" alt="payment"></li>
                            <li><img src="src/assets/images/footer/delta.png" alt="payment"></li>
                            <li><img src="src/assets/images/footer/cirrus.png" alt="payment"></li>
                            <li><img src="src/assets/images/footer/paypal.png" alt="payment"></li>
                        </ul>
                    </div>
                </div>
            </div>
